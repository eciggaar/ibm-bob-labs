...
Advance to [Plan and implement complex features](/labs/bob-intro/04---plan-and-implement-complex-features) to learn about the agentic chat sidebar, which is the primary interface for complex, multi-step development tasks in Bob.