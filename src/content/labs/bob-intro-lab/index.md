...
Advance to [Start a project with /init and AGENTS.md](/labs/bob-intro/01%20-%20Start%20a%20project) to learn how Bob uses the `/init` command to set up context in a new or existing project.
